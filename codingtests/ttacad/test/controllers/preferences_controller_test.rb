...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create preference' do
    assert_difference('Preference.count') do
      post preferences_url, params: {preference: {animal: @preference.animal, person_id: @preference.person_id}}
    end
  ...
  test 'should update preference' do
    patch preference_url(@preference), params: {preference: {animal: @preference.animal, person_id: @preference.person_id}}
